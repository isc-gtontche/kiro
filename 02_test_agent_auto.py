#!/usr/bin/env python3
"""
Test script for returns_refunds_agent (Auto-run version)
...
for test in test_questions:
    ...
    try:
        ...
        print(f"\nAgent Response:\n{result}")
        results.append({"test": test['id'], "status": "✅ PASSED", "error": None})
    except Exception as e:
        print(f"\n❌ Error: {e}")
        import traceback
        traceback.print_exc()
        results.append({"test": test['id'], "status": "❌ FAILED", "error": str(e)})
